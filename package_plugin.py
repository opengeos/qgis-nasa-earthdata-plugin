#!/usr/bin/env python3
"""
Package the NASA Earthdata QGIS plugin for upload to the official QGIS plugin repository.

This script creates a zip file with the following characteristics:
- Root folder renamed from 'nasa_earthdata' to the target plugin name
...
def package_plugin(
    ...
    target_name: str = "nasa_earthdata",
    ...
    Args:
        source_dir: Path to the nasa_earthdata directory
        output_path: Optional path for the output zip file
        target_name: Name for the root folder in the zip (default: 'nasa_earthdata')
...
def main():
    parser = argparse.ArgumentParser(
        description="Package NASA Earthdata QGIS plugin for repository upload",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output path for the zip file (default: nasa_earthdata-{version}.zip in the same folder as this script)",
    )
    parser.add_argument(
        "--source",
        "-s",
        type=Path,
        default=None,
        help="Source directory (default: nasa_earthdata in the same folder as this script)",
    )
    parser.add_argument(
        "--name",
        "-n",
        type=str,
        default="nasa_earthdata",
        help="Target plugin name for the zip root folder (default: nasa_earthdata)",
    )
    parser.add_argument(
        "--no-version",
        action="store_true",
    ...
    source_dir = args.source if args.source else script_dir / "nasa_earthdata"
