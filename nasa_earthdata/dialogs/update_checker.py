"""
Update Checker Dialog for NASA Earthdata Plugin
...
class DownloadWorker(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            temp_dir = tempfile.mkdtemp(prefix="nasa_earthdata_update_")
            ...
            for root, dirs, files in os.walk(extract_dir):
                if "metadata.txt" in files and "nasa_earthdata.py" in files:
            ...
            try:
                ...
                def is_valid_plugin_dir(path):
                    ...
                    ) and os.path.exists(os.path.join(path, "nasa_earthdata.py"))
...
class UpdateCheckerDialog(QDialog):
    ...
    def __init__(self, plugin_dir, parent=None):
        ...
        self.setWindowTitle("NASA Earthdata Plugin Update")
    ...
    def _setup_ui(self):
        ...
        # Header
        header_label = QLabel("NASA Earthdata Plugin Update Checker")
        header_font = QFont()
        ...
        self.check_btn.setStyleSheet("background-color: #0B3D91; color: white;")
    ...
    def _on_download_finished(self, install_path):
        ...
        QMessageBox.information(
            self,
            "Update Complete",
            f"NASA Earthdata Plugin has been updated to version {self.latest_version}.\n\n"
