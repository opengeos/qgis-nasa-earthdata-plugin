#!/bin/bash
# Installation script for NASA Earthdata QGIS Plugin
#
# Usage:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --name, -n NAME   Plugin folder name (default: nasa_earthdata)"
...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    echo "Please manually copy the nasa_earthdata folder to your QGIS plugins directory."
    exit 1
fi
